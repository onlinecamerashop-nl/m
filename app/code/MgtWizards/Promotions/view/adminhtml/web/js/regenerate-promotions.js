...
define(["jquery", "mage/translate"], function ($, $t) {
    $.widget("mgtwizards.regeneratePromotions", {
        options: {
            action_url: null,
        },
        ...
        _create: function () {
            ...
            this.element.on("click", function () {
                ...
                self.runRegeneratePromotions();
            });
        },

        runRegeneratePromotions: function () {
            var params = { "regenerate-promotions": true };
            var self = this;
            $.ajax({
    ...
    return $.mgtwizards.regeneratePromotions;
});