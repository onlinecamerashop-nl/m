...
namespace MgtWizards\SlideBannerHyva\Block\Adminhtml\Slide;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
		$collection = $this->_objectManager->create('MgtWizards\SlideBannerHyva\Model\Slide', [])->getCollection()->joinSlider();
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn(
            ...
            [
                'header' => __('Images'),
                'renderer' => 'MgtWizards\SlideBannerHyva\Block\Adminhtml\Slide\Renderer\Image',
                'filter' => false,
                'order' => false,
				'options'=> [1=>__('Enable'), 2=>__('Disable')],
                'header_css_class' => 'col-id',
