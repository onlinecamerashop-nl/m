...
namespace MgtWizards\Labels\Block\Adminhtml\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'mgtwizards_labels_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
        ...
        $newChildUrl = $this->getUrl(
            'mgtwizards_labels/index/newConditionHtml/form/' . $conditionsFieldSetId,
