...
/**
 * Source model for Product Page Layout options with preview images.
 */
class Layout implements ArrayInterface
{
    ...
    public function toArray(): array
    {
        return [
            'product_1' => [
                'label' => __('Product 1 - Default'),
                'image' => $this->assetRepo->getUrl('ShopWhizzy_DigitalTheme::images/product-version-01.jpg')
            ],
        ];
    }
}